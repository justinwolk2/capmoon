...
{"ownershipStatus":"Acquisition or Refinance","dealType":"one of Construction/Value add/New Development/Bridge/Takeout/Investment/C&I","assetType":"one of Apartments/Condos/Office/Mixed Use/Hotel/Hospitality/Land/Self-storage/Other etc","loanAmount":"dollar amount like $15,000,000","propertyValue":"dollar amount","selectedStates":["FL"],"recourseType":"FULL or NON RECOURSE or CASE BY CASE","dscr":"number like 1.25","numUnits":"number if mentioned","numBuildings":"number if mentioned"}
...
function stepIndex(step: MatcherStep): number {
  const steps: MatcherStep[] = ["ai-prompt", "start", "asset-count", "asset-form", "review", "results"];
...
export default function Home() {
  ...
  async function handleAiSubmit() {
    ...
    } catch { setAiError("Something went wrong. Please try again or use manual entry."); }
    setAiLoading(false);
  }
                  ...
                  {matcherStep === "asset-count" && (
                    <div className="max-w-2xl">
                      <div className={cardClass + " p-8"}>
                        ...
                        <p className="text-sm text-gray-500 mb-8">How many assets and how should they be treated?</p>
                        <div className="space-y-6">
              ...
              {activeTab === "uploads" && (
                <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
                  ...
                  <div className={cardClass + " p-6"}>
                    ...
                    <div className="flex flex-wrap gap-2 mb-5">{["Program Name", "Contact Person", "Email Address", "Phone Number", "Website", "Type of Loans", "Program", "Property Types", "Loan Terms", "Min Loan Size", "Max Loan Size", "Max LTV", "Target States", "Sponsor States", "Recourse", "Capital Type", "Source Tag"].map((field) => (<span key={field} className="px-3 py-1 rounded-full text-xs border border-[#0a1f44]/20 text-[#0a1f44] font-medium">{field}</span>))}</div>
