...
export async function GET() {
  ...
  const deals = [
    { id: 1001, submittedAt: "3/10/2026, 9:15:00 AM", seekerName: "Marcus Bellfield", seekerEmail: "mbellfield@email.com", seekerPhone: "305-555-0101", capitalType: "Senior", assetMode: "single", collateralMode: "", status: "assigned", assignedAdvisorIds: [1], notes: "Borrower has strong track record in South Florida multifamily. Looking for 5-year term IO.",
      photos: [
        { id: 1, url: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&q=80", caption: "Property Exterior — Biscayne Blvd" },
        { id: 2, url: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&q=80", caption: "Pool & Amenity Deck" },
        { id: 3, url: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&q=80", caption: "Unit Interior" },
        { id: 4, url: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&q=80", caption: "Building Facade" },
      ],
    ...
    { id: 1002, submittedAt: "3/11/2026, 2:30:00 PM", seekerName: "Diana Okafor", seekerEmail: "dokafor@email.com", seekerPhone: "212-555-0202", capitalType: "Senior", assetMode: "single", collateralMode: "", status: "pending", assignedAdvisorIds: [1], notes: "Class A office in Midtown. Strong in-place tenancy with 3 years remaining on anchor lease.",
      photos: [
        { id: 1, url: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80", caption: "Office Lobby" },
        { id: 2, url: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=800&q=80", caption: "Building Exterior — 1221 Avenue of the Americas" },
        { id: 3, url: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=800&q=80", caption: "Office Floor Plan" },
      ],
    ...
    { id: 1003, submittedAt: "3/12/2026, 11:00:00 AM", seekerName: "Trevor Sandoval", seekerEmail: "tsandoval@email.com", seekerPhone: "713-555-0303", capitalType: "Preferred Equity", assetMode: "single", collateralMode: "", status: "assigned", assignedAdvisorIds: [2], notes: "Ground-up development in Houston. Shovel ready, all permits in place.",
      photos: [
        { id: 1, url: "https://images.unsplash.com/photo-1467533003447-e295ff1b0435?w=800&q=80", caption: "Site — 3200 Main Street, Houston" },
        { id: 2, url: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&q=80", caption: "Rendering — Proposed Development" },
        { id: 3, url: "https://images.unsplash.com/photo-1555636222-cae831e670b3?w=800&q=80", caption: "Comparable Property" },
      ],
    ...
    { id: 1004, submittedAt: "3/13/2026, 4:45:00 PM", seekerName: "Rachel Kim", seekerEmail: "rkim@email.com", seekerPhone: "404-555-0404", capitalType: "Mezzanine", assetMode: "single", collateralMode: "", status: "pending", assignedAdvisorIds: [2], notes: "Full-service hotel in downtown Atlanta. STR and corporate travel demand drivers.",
      photos: [
        { id: 1, url: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&q=80", caption: "Hotel Exterior — Peachtree Center" },
        { id: 2, url: "https://images.unsplash.com/photo-1582719508461-905c673771fd?w=800&q=80", caption: "Hotel Lobby" },
        { id: 3, url: "https://images.unsplash.com/photo-1578683010236-d716f9a3f461?w=800&q=80", caption: "Guest Room" },
      ],
